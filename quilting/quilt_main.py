...
if __name__ == "__main__":
    ...
    for i in range(2897, iterations):
        print(i)
        image = quilt(random.sample(filenames, 4000), block_size, (num_block, num_block), mode)
        image.save(f'./DCGAN_mdts/{args.mode.lower()}-b{args.block_size}-n{args.num_block}_' + str(i) + '.png')